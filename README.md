# meus-exercicios-python-iniciante-3
...
# Bloco 1.
print("Todos os elementos da primeira linha:", "\033[0;34m")
...
# Quarta Condição.
    ...
    print(f"Todos os elementos da terceira coluna: \033[0;31m{matriz[0][3]}, {matriz[1][3]} e {matriz[2][3]}\033[m.")
